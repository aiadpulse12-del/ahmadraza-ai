...
const Footer = () => {
  ...
  return (
    <footer ref={footerRef} className="border-t border-border/50 py-10 px-4 relative overflow-hidden">
      {/* Floating particles */}
      <div className="orb orb-violet w-40 h-40 -top-20 left-1/4 opacity-30" />
      <div className="orb orb-blue w-32 h-32 -bottom-16 right-1/4 opacity-20" />

      <div className="container mx-auto flex flex-col sm:flex-row items-center justify-between gap-6 relative z-10">
        <a href="#" className="font-display text-xl font-bold text-gradient">AR.</a>
